            ...
            <div className="hero h-[80vh]" style={{ backgroundImage: 'url(https://i.ibb.co/dJZsR7H/Rectangle-4288.png)' }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="">
                        ...
                        <input type="search" onChange={handleSearch} name="search" placeholder="Search here..." className="p-3 mx-0" />
                        <button onClick={handleValue} className="btn p-5  bg-[#FF444A] text-white rounded-md">Search</button>
                    </div>
                </div>
            </div>
        </div>
